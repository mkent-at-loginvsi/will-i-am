...
# Startup Event on RDS 2012R2 Session Host
...
& "$am_env_files\config\plugins\6952e8c1-459a-4ed3-b4ec-2506575e2069\Optional\DisableRDSHostMaintenance.ps1" # Move RDSH to production collection
